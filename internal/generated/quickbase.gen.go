...
const (
	Address            CreateFieldJSONBodyFieldType = "address"
	Checkbox           CreateFieldJSONBodyFieldType = "checkbox"
	Currency           CreateFieldJSONBodyFieldType = "currency"
	Date               CreateFieldJSONBodyFieldType = "date"
	Datetime           CreateFieldJSONBodyFieldType = "datetime"
	Duration           CreateFieldJSONBodyFieldType = "duration"
	Email              CreateFieldJSONBodyFieldType = "email"
	File               CreateFieldJSONBodyFieldType = "file"
	Multitext          CreateFieldJSONBodyFieldType = "multitext"
	Multiuser          CreateFieldJSONBodyFieldType = "multiuser"
	Numeric            CreateFieldJSONBodyFieldType = "numeric"
	Percent            CreateFieldJSONBodyFieldType = "percent"
	Phone              CreateFieldJSONBodyFieldType = "phone"
	Rating             CreateFieldJSONBodyFieldType = "rating"
	RichText           CreateFieldJSONBodyFieldType = "rich-text"
	Text               CreateFieldJSONBodyFieldType = "text"
	TextMultiLine      CreateFieldJSONBodyFieldType = "text-multi-line"
	TextMultipleChoice CreateFieldJSONBodyFieldType = "text-multiple-choice"
	Timeofday          CreateFieldJSONBodyFieldType = "timeofday"
	Timestamp          CreateFieldJSONBodyFieldType = "timestamp"
	Url                CreateFieldJSONBodyFieldType = "url"
	User               CreateFieldJSONBodyFieldType = "user"
)
...
type CreateSolutionParams struct {
	// XQBLErrorsAsSuccess If this header is set to true, the API will return a 207 status code even if there are errors. The errors will be returned in the response body.
...
type PlatformAnalyticEventSummariesResponse struct {
	...
	JSON200      *struct {
		...
		// GroupBy How the events should be grouped.
		GroupBy PlatformAnalyticEventSummaries200GroupBy `json:"groupBy"`
		...
		Results []struct {
			...
			EventTypes []struct {
				...
				BillingCategory *PlatformAnalyticEventSummaries200ResultsEventTypesBillingCategory `json:"billingCategory,omitempty"`
		...
		Where []struct {
			...
			// Type The type of item to filter by.
			Type PlatformAnalyticEventSummaries200WhereType `json:"type"`
		} `json:"where"`
	}
}
type PlatformAnalyticEventSummaries200GroupBy string
type PlatformAnalyticEventSummaries200ResultsEventTypesBillingCategory string
type PlatformAnalyticEventSummaries200WhereType string
...
type PlatformAnalyticReadsResponse struct {
	...
	JSON200      *struct {
		...
		Reads                PlatformAnalyticReads_200_Reads `json:"reads"`
		AdditionalProperties map[string]interface{}          `json:"-"`
	}
}
type PlatformAnalyticReads_200_Reads_Integrations struct {
...
type PlatformAnalyticReads_200_Reads struct {
	// Integrations Total integration reads for the realm on the specified date.
	Integrations PlatformAnalyticReads_200_Reads_Integrations `json:"integrations"`
